...
const InfoCard = ({ title, children }: InfoCardProps) => (
  <div className="bg-[#111827] border border-gray-700/50 p-4 sm:p-6 rounded-2xl flex flex-col h-full min-h-[160px]">
    <h3 className="text-sm font-semibold tracking-wider text-gray-400 uppercase mb-2 sm:mb-3">{title}</h3>
...
export default function EventDetailsSection() {
  return (
    <section id="event-details" className="text-white py-8 sm:py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8 sm:mb-16">
          ...
          >
            Event <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-400">Details</span>
          </h2>
          <div className="w-16 sm:w-24 h-1 bg-gradient-to-r from-cyan-400 to-blue-400 mx-auto rounded-full" />
          <p 
            className="text-gray-300 text-base sm:text-lg mt-4 sm:mt-6 max-w-2xl mx-auto px-4"
            style={{ fontFamily: "TAN Headline, serif" }}
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 items-start">
          ...
          <div className="relative w-full flex items-center mt-4 sm:mt-12">
            ...
            <img
              ...
              className="relative z-[2] w-full h-auto object-cover rounded-2xl shadow-lg"
              onError={(e) => {
          ...
          <div className="flex flex-col gap-4 sm:gap-6 relative z-[3]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              <InfoCard title="Date">
                <div>
                  <p className="text-base sm:text-lg font-semibold">August 10, 2025</p>
                  <p className="text-base sm:text-lg font-semibold mb-3">at 6PM SAST</p>
                </div>
                <a 
                  href="#calendar" 
                  onClick={(e) => {
              ...
              <InfoCard title="Prize Pool">
                <div className="flex items-center justify-center h-full">
                  <p className="text-3xl sm:text-4xl font-bold text-cyan-400">R50,000</p>
                </div>
              </InfoCard>
              ...
              <InfoCard title="Format">
                <div className="flex flex-col justify-center h-full">
                  <p className="text-base sm:text-lg font-semibold">Round Robin,</p>
                  <p className="text-base sm:text-lg font-semibold">Double Elimination</p>
                </div>
              </InfoCard>
            </div>
            ...
            <a 
              ...
              className="bg-[#111827] border border-gray-700/50 rounded-2xl p-4 sm:p-6 text-center"
            >
              <div className="flex items-center justify-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                ...
                <p className="text-base sm:text-lg font-bold tracking-widest text-green-400">REGISTRATION OPEN</p>
              </div>
              ...
              <Button
                ...
                className="w-full sm:w-auto bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold px-8 py-6 text-lg rounded-lg shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 cursor-pointer"
              >
                Register Now
              </Button>
            </a>
